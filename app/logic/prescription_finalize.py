...
def finalize_prescription(
    ...
    Universal safety rules always run; template-specific rules gated by USE_STRUCTURED_COACHING_TEMPLATES.
    """
    if state is None:
    ...
    if not hard_violations and settings.USE_STRUCTURED_COACHING_TEMPLATES:
